...
export async function addGuest(g: Partial<Guest>): Promise<number | null> {
  try {
    ...
    const msg = "There was a problem adding the guest:";
...
export async function updateGuest(g: Partial<Guest>): Promise<boolean> {
  try {
    ...
    const msg = "There was a problem updating the guest:";
    console.error(msg, err);
    reportApiError(msg, err);
    return false;
  }
...
export async function deleteGuest(id: number): Promise<boolean> {
  try {
    ...
    const msg = "There was a problem deleting the guest:";
    console.error(msg, err);
    reportApiError(msg, err);
    return false;
  }
...
export async function getGuestData(
  ...
  try {
    ...
    const msg = "There was a problem getting the guests's data:";
    console.error(msg, err);
    reportApiError(msg, err);
    return null;
  }
...
export async function getGuests(
  ...
  try {
    ...
    const msg = "There was a problem getting guests:";
    console.error(msg, err);
    reportApiError(msg, err);
    return null;
  }
...
export async function getGuestsData(
  ...
  try {
    ...
    const msg = "There was a problem getting guests data:";
    console.log(msg, err);
    reportApiError(msg, err);
    return null;
  }
...
export async function getGuestsWithQuery(
  ...
  try {
    ...
    const msg = "There was a problem querying guests:";
    console.error(msg, err);
    reportApiError(msg, err);
    return null;
  }
